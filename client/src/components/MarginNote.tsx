...
export function NoteBlock({
  ...
  return (
    <section className="mb-6 last:mb-0">
      <div className="ui text-ink-400 mb-2 text-[13px] tracking-[0.16em] uppercase">{label}</div>
      <div className="ui text-ink-500 space-y-2 text-[13px] leading-relaxed">{children}</div>
    </section>
  );
}
...
export function NoteFigure({
  ...
  return (
    <div className="hair-t pt-2">
      ...
      <div className="ui text-ink-500 mt-1 text-[13px] leading-relaxed">{caption}</div>
    </div>
  );
}
