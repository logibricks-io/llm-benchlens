...
/*
 * Not in the standard DOM lib, so it is declared locally. The i18n pass dropped
 * this type plus the two platform probes below and imported them from
 * `@/lib/utils`, where they never existed; they are restored here verbatim,
 * along with the original storage keys and timings (changing those would silently
 * re-prompt users who had already dismissed the banner).
 */
  ...
  return (
    ...
    >
      <div className="flex items-start gap-2.5">
        ...
        <button
          onClick={dismiss}
          aria-label={t.installPrompt.closeAria}
